...
definePage({
  meta: {
    layout: 'blank',
    public: true,
    title: 'Products - Community Marketplace',
  },
})
</script>
    ...
    <div class="products-container">
      <VContainer class="py-8" style="max-width: 1400px;">
        ...
        <div class="text-center mb-8">
          <h1 class="text-h2 font-weight-bold mb-4">Community Marketplace</h1>
          <p class="text-h6 text-medium-emphasis mb-6 mx-auto" style="max-width: 600px;">
            Discover quality products from our trusted community vendors. Support local businesses and find everything you need.
          </p>
        </div>
        ...
        <VRow v-else>
          ...
          <VCol cols="12" lg="8">
            <div class="d-flex justify-space-between align-center mb-6">
              <h2 class="text-h4 font-weight-bold">Our Products</h2>
